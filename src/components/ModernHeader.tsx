  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
            ...
            {['Home', 'About', 'Solutions', 'Industries', 'Testimonials', 'Contact'].map((item) => (
              <button 
                ...
                className={`text-sm font-medium transition-all duration-300 hover:scale-105 ${
                  isScrolled 
                    ? 'text-gray-700 hover:text-sapphire' 
            ...
            <Button 
              ...
              className={`px-6 py-2 rounded-full font-semibold transition-all duration-300 hover:scale-105 ${
                isScrolled 
                  ...
                  : 'bg-white text-sapphire hover:bg-blue-50'
              }`}
            >
              Get Started
            </Button>
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-gray-200/20 bg-white/95 backdrop-blur-xl">
